...
os.system('CLS')  
infile_path = "D:/Creality/Python2/BW-photo-source.nc" #+ input("Inputfile =: D:/Creality/Python/")
print(f"Infile: {infile_path}")
print()
outfile_path = "D:/Creality/Python2/BW-photo-out.nc" #+ input("Outputfile =: /D:/Creality/Python/")
print(f"Outfile: {outfile_path}")
print()
logfile_path = "D:/Creality/Python2/Logfile.txt"
